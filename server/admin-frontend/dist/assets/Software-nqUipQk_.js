import{_ as G,a as b,r as Q,i as E,c as h,o as V,b as o,d as l,w as t,e as r,g as m,l as A,A as O,t as R,B as J,E as u}from"./index-CTIWMd4I.js";import{l as $,p as v}from"./index-DN7A4lKi.js";const L={class:"table-card"},W={style:{"margin-top":"0"}},H={class:"table-card"},X={style:{"margin-top":"0"}},Y={style:{"margin-left":"12px",color:"#666"}},Z={class:"table-card"},ee={style:{"margin-top":"0"}},le={style:{width:"600px"}},te={style:{"margin-top":"8px",display:"flex",gap:"8px"}},oe={key:0,class:"qrcode-preview"},ae=["src"],ne={class:"qrcode-overlay"},ie={key:1,class:"qrcode-placeholder"},se={__name:"Software",setup(re){const i=b({registration_enabled:!0,machine_code_limit:1,machine_change_cooldown:30,login_fail_limit:5,login_lock_duration:30}),n=b({disclaimer:"",support_qrcode_url:"",group_join_url:"",tutorial_url:"",donate_url:""}),c=b({dashscope_api_key:""}),y=Q(!1),I=async()=>{try{const a=await $();a.data&&(i.registration_enabled=a.data.registration_enabled==="1"||a.data.registration_enabled===!0,i.machine_code_limit=parseInt(a.data.machine_code_limit)||1,i.machine_change_cooldown=parseInt(a.data.machine_change_cooldown)||30,i.login_fail_limit=parseInt(a.data.login_fail_limit)||5,i.login_lock_duration=parseInt(a.data.login_lock_duration)||30,n.disclaimer=a.data.disclaimer||"",n.support_qrcode_url=a.data.support_qrcode_url||"",n.group_join_url=a.data.group_join_url||"",n.tutorial_url=a.data.tutorial_url||"",n.donate_url=a.data.donate_url||"",c.dashscope_api_key=a.data.dashscope_api_key||"")}catch(a){console.error("加载设置失败",a)}},q=async()=>{try{await v({registration_enabled:i.registration_enabled?"1":"0",machine_code_limit:String(i.machine_code_limit),machine_change_cooldown:String(i.machine_change_cooldown),login_fail_limit:String(i.login_fail_limit),login_lock_duration:String(i.login_lock_duration)}),u.success("保存成功")}catch{}},k=async()=>{try{await v({disclaimer:n.disclaimer,support_qrcode_url:n.support_qrcode_url,group_join_url:n.group_join_url,tutorial_url:n.tutorial_url,donate_url:n.donate_url}),u.success("保存成功")}catch{}},U=()=>{n.disclaimer=`《丸子配音》免责条款申明
