...
const testMail = (data) => api.post("/admin/test-mail", data);
const testDashScopeApi = (data) => api.post("/admin/test-dashscope", data);
export {
  getCards as a,
  getOperationLogs as b,
  updateAdminProfile as c,
  testDashScopeApi as d,
  exportUsers as e,
  updateUser as f,
