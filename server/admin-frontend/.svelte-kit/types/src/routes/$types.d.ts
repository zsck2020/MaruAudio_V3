...
type LayoutRouteId = RouteId | "/(admin)" | "/(admin)/announcements" | "/(admin)/cards" | "/(admin)/character-packs" | "/(admin)/commission" | "/(admin)/dashboard" | "/(admin)/logs" | "/(admin)/marketing" | "/(admin)/settings" | "/(admin)/software" | "/(admin)/users" | "/login" | null
