...
class EngineManager:
    ...
    def get_v15(self):
        ...
        with self._lock:
            ...
            try:
                ...
                cfg_path = os.path.join(_V15_DIR, "checkpoints", "config.yaml")
                model_dir = os.path.join(_V15_DIR, "checkpoints")
    ...
    def get_v20(self):
        ...
        with self._lock:
            ...
            try:
                ...
                cfg_path = os.path.join(_V20_DIR, "checkpoints", "config.yaml")
                model_dir = os.path.join(_V20_DIR, "checkpoints")
    ...
    def check_v15(self) -> dict:
        ...
        # 检查 checkpoint 是否存在
        ckpt = os.path.join(_V15_DIR, "checkpoints", "config.yaml")
    ...
    def check_v20(self) -> dict:
        ...
        ckpt = os.path.join(_V20_DIR, "checkpoints", "config.yaml")
        if os.path.isfile(ckpt):
    ...
    def status(self) -> list[dict]:
        """返回所有引擎状态"""
        return [self.check_v15(), self.check_v20()]
